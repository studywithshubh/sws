...
const buttonVariants = {
    general_1: "bg-white text-black px-6 font-bold py-1 rounded-md hover:bg-gray-200 hover:scale-105 transition-all duration-300",
    general_2: "bg-black text-white px-6 font-bold py-1 rounded-md hover:bg-slate-800 hover:scale-105 transition-all duration-300",
